...
const colors = {
  ...
  buttonOutline: lightThemeColorValues.black,
  buttonOutlineText: lightThemeColorValues.black,
  buttonOutlineSecondary: lightThemeColorValues.white,
  buttonOutlineSecondaryText: lightThemeColorValues.white,
